...
namespace Doara.Migrations
{
    ...
    [Migration("20250510233908_InvoiceType")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Doara.Sklady.Entities.StockMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ContainerItemId");

                    b.HasIndex("Id");

                    b.ToTable("Sklady_StockMovement", (string)null);
                });
            ...
            modelBuilder.Entity("Doara.Sklady.Entities.StockMovement", b =>
                {
                    b.HasOne("Doara.Sklady.Entities.ContainerItem", "ContainerItem")
                        .WithMany("Movements")
                        .HasForeignKey("ContainerItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
